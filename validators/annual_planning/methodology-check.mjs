...
const REQUIRED_FAMILIES = [
  ['OKR', 'Marketing-Funnel'],
  ['Marketing-Calendar', '4P-Rhythm'],
  ['AARRR-Funnel'],
]
...
export function methodologyCheck(output) {
  ...
  const checks = [
    { keyword: ['OKR', 'Objective', 'Key Result', '目标'], desc: 'OKR 框架' },
    { keyword: ['日历', '节奏', '季度', 'Q1', 'Q2', 'Q3', 'Q4'], desc: '年度日历/季度节奏' },
    { keyword: ['预算', '分配', '投入', '产出'], desc: '预算分配' },
    { keyword: ['漏斗', 'AARRR', '激活', '留存', '推荐'], desc: 'AARRR 漏斗或 KPI 表' },
  ]
